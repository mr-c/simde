...
test_simde_vcvth_n_s32_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
    ...
    { SIMDE_FLOAT16_VALUE(  -822.50),
      -INT32_C(        6580),
      -INT32_C(       52640),
      -INT32_C(      842240),
      -INT32_C(     6737920),
      -INT32_C(    53903360) },
    { SIMDE_FLOAT16_VALUE(   312.25),
       INT32_C(        2498),
       INT32_C(       19984),
       INT32_C(      319744),
       INT32_C(     2557952),
       INT32_C(    20463616) },
    { SIMDE_FLOAT16_VALUE(   912.50),
       INT32_C(        7300),
       INT32_C(       58400),
       INT32_C(      934400),
       INT32_C(     7475200),
       INT32_C(    59801600) },
    { SIMDE_FLOAT16_VALUE(  -254.25),
      -INT32_C(        2034),
      -INT32_C(       16272),
      -INT32_C(      260352),
      -INT32_C(     2082816),
      -INT32_C(    16662528) },
    { SIMDE_FLOAT16_VALUE(   -44.66),
      -INT32_C(         357),
      -INT32_C(        2858),
      -INT32_C(       45728),
      -INT32_C(      365824),
      -INT32_C(     2926592) },
    { SIMDE_FLOAT16_VALUE(  -299.00),
      -INT32_C(        2392),
      -INT32_C(       19136),
      -INT32_C(      306176),
      -INT32_C(     2449408),
      -INT32_C(    19595264) },
    { SIMDE_FLOAT16_VALUE(  -429.75),
      -INT32_C(        3438),
      -INT32_C(       27504),
      -INT32_C(      440064),
      -INT32_C(     3520512),
      -INT32_C(    28164096) },
    { SIMDE_FLOAT16_VALUE(   303.75),
       INT32_C(        2430),
       INT32_C(       19440),
       INT32_C(      311040),
       INT32_C(     2488320),
...
test_simde_vcvth_n_s64_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
   ...
   { SIMDE_FLOAT16_VALUE(   117.06),
       INT64_C(                 936),
       INT64_C(                7492),
       INT64_C(              119872),
       INT64_C(              958976),
       INT64_C(             7671808) },
    { SIMDE_FLOAT16_VALUE(   108.44),
       INT64_C(                 867),
       INT64_C(                6940),
       INT64_C(              111040),
       INT64_C(              888320),
       INT64_C(             7106560) },
    { SIMDE_FLOAT16_VALUE(   134.50),
       INT64_C(                1076),
       INT64_C(                8608),
       INT64_C(              137728),
       INT64_C(             1101824),
       INT64_C(             8814592) },
    { SIMDE_FLOAT16_VALUE(   871.00),
       INT64_C(                6968),
       INT64_C(               55744),
       INT64_C(              891904),
       INT64_C(             7135232),
       INT64_C(            57081856) },
    { SIMDE_FLOAT16_VALUE(    55.31),
       INT64_C(                 442),
       INT64_C(                3540),
       INT64_C(               56640),
       INT64_C(              453120),
       INT64_C(             3624960) },
    { SIMDE_FLOAT16_VALUE(  -920.50),
      -INT64_C(                7364),
      -INT64_C(               58912),
      -INT64_C(              942592),
      -INT64_C(             7540736),
      -INT64_C(            60325888) },
    { SIMDE_FLOAT16_VALUE(   307.25),
       INT64_C(                2458),
       INT64_C(               19664),
       INT64_C(              314624),
       INT64_C(             2516992),
       INT64_C(            20135936) },
    { SIMDE_FLOAT16_VALUE(  -210.00),
      -INT64_C(                1680),
      -INT64_C(               13440),
      -INT64_C(              215040),
      -INT64_C(             1720320),
...
test_simde_vcvth_n_u32_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
    ...
    { SIMDE_FLOAT16_VALUE(  -756.00),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0) },
    { SIMDE_FLOAT16_VALUE(   633.50),
      UINT32_C(      5068),
      UINT32_C(     40544),
      UINT32_C(    648704),
      UINT32_C(   5189632),
      UINT32_C(  41517056) },
    { SIMDE_FLOAT16_VALUE(   441.25),
      UINT32_C(      3530),
      UINT32_C(     28240),
      UINT32_C(    451840),
      UINT32_C(   3614720),
      UINT32_C(  28917760) },
    { SIMDE_FLOAT16_VALUE(  -273.50),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0) },
    { SIMDE_FLOAT16_VALUE(  -799.00),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0) },
    { SIMDE_FLOAT16_VALUE(   294.50),
      UINT32_C(      2356),
      UINT32_C(     18848),
      UINT32_C(    301568),
      UINT32_C(   2412544),
      UINT32_C(  19300352) },
    { SIMDE_FLOAT16_VALUE(  -885.50),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0) },
    { SIMDE_FLOAT16_VALUE(   -58.94),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
      UINT32_C(         0),
...
test_simde_vcvth_n_u64_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
    ...
    { SIMDE_FLOAT16_VALUE(  -744.00),
      UINT64_C(                   0),
      UINT64_C(                   0),
      UINT64_C(                   0),
      UINT64_C(                   0),
      UINT64_C(                   0) },
    { SIMDE_FLOAT16_VALUE(   330.75),
      UINT64_C(                2646),
      UINT64_C(               21168),
      UINT64_C(              338688),
      UINT64_C(             2709504),
      UINT64_C(            21676032) },
    { SIMDE_FLOAT16_VALUE(   819.00),
      UINT64_C(                6552),
      UINT64_C(               52416),
      UINT64_C(              838656),
      UINT64_C(             6709248),
      UINT64_C(            53673984) },
    { SIMDE_FLOAT16_VALUE(   480.75),
      UINT64_C(                3846),
      UINT64_C(               30768),
      UINT64_C(              492288),
      UINT64_C(             3938304),
      UINT64_C(            31506432) },
    { SIMDE_FLOAT16_VALUE(   678.00),
      UINT64_C(                5424),
      UINT64_C(               43392),
      UINT64_C(              694272),
      UINT64_C(             5554176),
      UINT64_C(            44433408) },
    { SIMDE_FLOAT16_VALUE(   637.00),
      UINT64_C(                5096),
      UINT64_C(               40768),
      UINT64_C(              652288),
      UINT64_C(             5218304),
      UINT64_C(            41746432) },
    { SIMDE_FLOAT16_VALUE(   -27.83),
      UINT64_C(                   0),
      UINT64_C(                   0),
      UINT64_C(                   0),
      UINT64_C(                   0),
      UINT64_C(                   0) },
    { SIMDE_FLOAT16_VALUE(   855.50),
      UINT64_C(                6844),
      UINT64_C(               54752),
      UINT64_C(              876032),
      UINT64_C(             7008256),
